...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(getConcreteDisposable);
  #pragma clang diagnostic pop
  static const J2ObjcClassInfo _SharedRxDisposableBuilder = { "SharedRxDisposableBuilder", "shared.app.splendo.sharedrx", NULL, methods, NULL, 7, 0x609, 1, 0, -1, -1, -1, -1, -1 };
